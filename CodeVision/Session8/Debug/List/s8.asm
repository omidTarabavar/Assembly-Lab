...
_0x0:
	.DB  0x4E,0x6F,0x20,0x44,0x61,0x74,0x61,0x0
	.DB  0x49,0x6E,0x70,0x75,0x74,0x20,0x3D,0x20
	.DB  0x0,0x43,0x6F,0x75,0x6E,0x74,0x20,0x3D
...
; 0000 0011     while (1){
_0x4:
; 0000 0012         Din = getchar();
	CALL _getchar
	MOV  R5,R30
; 0000 0013         lcd_clear();
	RCALL _lcd_clear
; 0000 0014         lcd_puts("Input = ");
	__POINTW2MN _0x3,8
	RCALL _lcd_puts
; 0000 0015         lcd_putchar(Din);
	MOV  R26,R5
	RCALL _lcd_putchar
...
; 0000 0017         Count++;
	INC  R4
; 0000 0018         sprintf(Buf,"Count = %d",Count);
	LDI  R30,LOW(_Buf)
	LDI  R31,HIGH(_Buf)
	ST   -Y,R31
	ST   -Y,R30
